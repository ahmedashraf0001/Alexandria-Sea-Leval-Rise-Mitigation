...
public class ChatContextValidator : AbstractValidator<ChatContext>
{
    public ChatContextValidator()
    {
        RuleFor(context => context.Scenario)
            .NotEmpty()
            .Must(value => value is "SSP126" or "SSP245" or "SSP370" or "SSP585")
            .WithMessage("Scenario must be one of SSP126, SSP245, SSP370, SSP585.");

        RuleFor(context => context.Year)
            .NotEmpty()
